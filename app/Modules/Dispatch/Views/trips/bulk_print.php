...
<head>
    ...
    <title>Bulk Trip Receipts (<?= count($trips) ?>)</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        @media print {
            ...
            .receipt { box-shadow: none !important; border: 1px solid #ccc !important; page-break-after: always; margin-bottom: 0 !important; }
            @page { margin: 12mm; }
        }
...
<!-- Toolbar -->
<div class="toolbar">
    <h2>Bulk Printing — <?= count($trips) ?> Receipts</h2>
